...
print("自己資本当期利益率は", ana_pro.roe(), "です")
print("使用総資本事業利益率は", ana_pro.roa(), "です")
...
geometric_mean = GeometricMean(4, 5000, 1000)
...
print("リスクを考慮した現在価値は", other_formulas.risk_adjusted_present_values(), "です\n")
...
theoretical_values = TheoreticalValue(30, 10000, 4000, 50000000, 400000000)
...
print("株価収益率は、", theoretical_values.price_earning_ratio(), "%です。")
